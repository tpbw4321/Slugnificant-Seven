...
#define ROTATION_ANGLE_TICKS 20 //20ms
...
#define POSTFUNCTION_FOR_ROTATION_ANGLE_SERVICE PostRotationAngleService
...
#define TIMER0_RESP_FUNC POSTFUNCTION_FOR_ROTATION_ANGLE_SERVICE
...
#define ROTATION_ANGLE_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "RotationAngleService.h"
// the name of the Init function
#define SERV_1_INIT InitRotationAngleService
// the name of the run function
#define SERV_1_RUN RunRotationAngleService
