...
//#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostTrackWireFSM

#define POSTFUNCTION_TRACKWIRE_SERVICE PostTrackWireService
...
#define TIMER0_RESP_FUNC POSTFUNCTION_TRACKWIRE_SERVICE
...
#define TRACKWIRE_SERVICE_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "TrackWireService.h"
// the name of the Init function
#define SERV_1_INIT InitTrackWireService
// the name of the run function
#define SERV_1_RUN RunTrackWireService
