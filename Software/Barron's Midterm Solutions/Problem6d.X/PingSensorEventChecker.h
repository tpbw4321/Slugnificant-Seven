...
#ifndef PINGSENSOREVENTCHECKER_H
#define	PINGSENSOREVENTCHECKER_H
 ...
 * @brief This function is a prototype event checker that will detect how far the closest object
 * is from the ping sensor in inches.
 * @note 
 * @author Barron Wong */
