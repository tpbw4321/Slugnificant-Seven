...
#define EVENT_CHECK_HEADER "TemplateEventChecker.h"//"ES_Configure.h""TemplateEventChecker.h"

/****************************************************************************/
// This is the list of event checking functions
#define EVENT_CHECK_LIST BeaconEvent 
...
#define TIMER0_RESP_FUNC PostTapeSensorService //tape sensor timer
#define TIMER1_RESP_FUNC PostBumperService //bumpers
#define TIMER2_RESP_FUNC PostTurnService //90 degree tank turn timeout //around obstacle timer //around obstacle timer //away tape timer
#define TIMER3_RESP_FUNC PostServoService 
...
#define TWO_MS_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define DEBOUNCE_TIMER 1
#define TURN_TIMER 2
#define SERVO_DELAY_TIMER 3
//#define SHAKE_HOPPER_TIMER 3
//#define AWAY_TOWARDS_TAPE_TIMER 4
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "TurnService.h"
// the name of the Init function
#define SERV_4_INIT InitTurnService
// the name of the run function
#define SERV_4_RUN RunTurnService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "ServoService.h"
// the name of the Init function
#define SERV_5_INIT InitServoService
// the name of the run function
#define SERV_5_RUN RunServoService
// How big should this services Queue be?
